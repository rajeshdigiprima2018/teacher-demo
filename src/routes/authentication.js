...
Auth.reloadRoutes = async function (params) {
	...
	router.post('/register/complete', controllers.authentication.registerComplete);
	router.post('/register/abort', controllers.authentication.registerAbort);
	//router.post('/login', Auth.middleware.applyCSRF, Auth.middleware.applyBlacklist, controllers.authentication.login);
	router.post('/login', Auth.middleware.applyBlacklist, controllers.authentication.login);
